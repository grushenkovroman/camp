...
- **Домен:** `camp.rasti24.ru` (DNS A → 84.22.133.11)
- **Сервер:** `ssh grushenkov@84.22.133.11`, Ubuntu 24.04, sudo без пароля
...
**Публично:**
- `GET /<team_uuid>` — страница команды (по умолчанию сегодня по МСК)
